    ...
    if (!isNaN(SoVe)) {
        ...
        document.querySelector('#addRows').insertAdjacentHTML(
            ...
            <div class="row" id="SoDong` + count + `" >
                        ...
                        <div class="col-md-2 col-xs-4">
                            <div class="item form-group">
                                    <input type="text" placeholder="Giá mua" value="` + GiaMua + `" onkeyup="formatNumber(document.getElementById(this.id).value,this.id);" id="GiaMua` + count + `" asp-for="GiaMua` + count + `" name="GiaMua` + count + `" class="form-control ">
                            </div>
                        </div>
                        <div class="col-md-2 col-xs-4" hidden>
                            <div class="item form-group">
                                    <input type="text" placeholder="Phí dịch vụ mua" value="` + PhiDVMua + `" onkeyup="formatNumber(document.getElementById(this.id).value,this.id);" id="PhiDVMua` + count + `" asp-for="PhiDVMua` + count + `" name="PhiDVMua` + count + `" class="form-control ">
                            </div>
                        </div>
                        <div class="col-md-2 col-xs-4">
                            <div class="item form-group">
                                    <input type="text" placeholder="Phí dịch vụ bán" value="` + PhiDVBan + `" onkeyup="formatNumber(document.getElementById(this.id).value,this.id);" id="PhiDVBan` + count + `" asp-for="PhiDVBan` + count + `" name="PhiDVBan` + count + `" class="form-control ">
                            </div>
                        </div>
                         <div class="col-md-2 col-xs-4">
                                        <div class="item form-group">
                                                <input type="text" placeholder="Phí hoàn" value="` + PhiHoan + `" onkeyup="formatNumber(document.getElementById(this.id).value,this.id);" id="PhiHoan` + count + `" asp-for="PhiHoan` + count + `" name="PhiHoan` + count + `" class="form-control ">
                                        </div>
                                    </div>
                        <div class="col-md-2 col-xs-4">
                            <div class="item form-group">
                                    <input type="text" placeholder="Chiết khấu" value="` + ChietKhau + `" onkeyup="formatNumber(document.getElementById(this.id).value,this.id);" id="ChietKhau` + count + `" asp-for="ChietKhau` + count + `" name="ChietKhau` + count + `" class="form-control ">
                            </div>
                        </div>
                    <div class="col-md-2 col-xs-4">
                                <div class="item form-group">
